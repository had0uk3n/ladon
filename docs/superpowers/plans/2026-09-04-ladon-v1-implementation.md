...
- [x] Run `cargo fmt --check`, strict clippy, all workspace tests/features, `cargo deny check`, and `scripts/smoke-test.sh`; expect pass.
...
- [x] Commit: `docs: prepare Ladon security preview`.
